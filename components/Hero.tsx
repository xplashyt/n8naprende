    ...
    <section id="top" className="mx-auto max-w-6xl px-4 pb-4 pt-10 sm:pt-16">
      <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-12">
        <div className="lg:col-span-5">
          <p className="dato text-ambar">Curso en video · tres niveles</p>
          ...
          <p className="mt-6 text-[1.0625rem] leading-relaxed text-gis">
            ...
            alguien te escribe. Aquí lo aprendes en tres niveles, desde el primer nodo
            hasta el agente de IA que usa tus propios flujos como herramientas.
          </p>
